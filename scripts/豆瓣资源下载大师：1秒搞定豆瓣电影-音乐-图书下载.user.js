...
<div class="rating_more" style="display:none"></div>`); // 修复部分情况$("div.rating_betterthan")不存在情况
            ...
            if (_version === "完整版") {
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "Spring", link: 'https://springsunday.net/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                    ]
                });
                site_map.push({
                    name: "2万+种PT内站",
                ...
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: "Brobits", link: 'https://brobits.cc/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                        { name: "EDEN", link: 'https://pt.hdbd.us/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                        { name: "GOD", link: 'https://ptsbao.club/torrents.php?incldead=1&search_area=1&notnewword=1&search=' + neizhan, },
                        ...
                        { name: "MoeCat", link: 'http://moecat.best/torrents.php?incldead=1&search_area=0&notnewword=1&search=' + unititle, },
                ...
                if (has_imdb) {
                    site_map.push({
                        ...
                        label: [
                            ...
                            { name: "LuluNZB", link: 'https://lulunzb.com/search/' + ywm, selector: "#browsetable a.title", selector_need_login: "div.login-box" },
                    ...
                    site_map.push({
                        ...
                        label: [
                            ...
                            { name: "DOGnzb", link: 'https://dognzb.cr/search?q=' + ywm, selector: "#featurebox > table > tbody > tr > td > table > tbody > tr.odd:gt(0)", selector_need_login: "#login" },
                            { name: "NZBFind", link: 'https://nzbfinder.ws/search/' + ywm, selector: "td.check + td a", selector_need_login: "div.account-form" },
                ...
                site_map.push({
                    name: "终生会员论坛",
                    label: [
                        { name: "古哥论坛", link: 'https://www.gugeys.cc/search.php?mod=forum&searchsubmit=yes&srchtxt=' + gunititle, selector: "div.tl li.pbw" },
            ...
            if (is_series) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: 'Pan58剧集', link: 'https://www.pan58.com/s?wd=' + unititle + '&s=1&t=0&p=1', selector: `.filetext p.fname:contains(${unititle})` },
                        ...
                        { name: '凌风云剧集', link: 'https://www.lingfengyun.com/search?wd=' + unititle + '&so_file=1&so_source=1&so_ext=8&so_array=file_desc&so_accur=100', csrf: {name: "so_token", update:"link"}, rewrite_href: true, selector: '.search_data_list div.tab' },
                        { name: '如风搜剧集', link: 'http://www.rufengso.net/s/comb/n-' + unititle + '&nd-d', selector: `h3 > a[title*='${unititle}']` },
            ...
            if (is_movie) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: 'Pan58电影', link: 'https://www.pan58.com/s?wd=' + unititle + '&s=2&t=0&p=1', selector: `.filetext p.fname:contains(${unititle})` },
                        ...
                        { name: '凌风云电影', link: 'https://www.lingfengyun.com/search?wd=' + unititle + '&so_file=1&so_source=1&so_ext=2&so_array=file_desc&so_accur=100', csrf: {name: "so_token", update:"link"}, rewrite_href: true, selector: '.search_data_list div.tab' },
                        { name: '如风搜电影', link: 'http://www.rufengso.net/s/comb/n-' + unititle + '&s-size1&f-f4', selector: `h3 > a[title*='${unititle}']` },
            ...
            if (is_anime) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: '嘀哩嘀哩', link: 'http://www.dilidili.one/search.php?q=' + unititle, selector: 'div.card p.slr' },
                    ]
                });
            }
            if (is_anime) {
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '新导搜索', link: 'https://s.xingdaoo.com/s_' + unititle + '.html', selector: 'div.ss-jg-lb li' },
                ]
            });
            site_map.push({
                name: "电影资源下载",
                label: [
                    ...
                    { name: 'BT迷', link: 'http://www.bttt6.com/search.asp?searchword=' + gunititle, selector: '#content h2.entry-title' },
                    ...
                    { name: '高清MP4', link: 'http://www.mp4ba.cc/index.php?m=search&c=index&a=init&modelid=1&q=' + unititle, selector: '.search_content .sousuo' },
                    { name: '高清电台', link: 'https://gaoqing.fm/s.php?q=' + unititle, selector: '#result1 div.row' },
                    { name: '高清电影', link: 'http://www.999hdhd.com/htm/search_topic_' + unititle + '_1.htm', selector: 'div.layout_left2 li' },
                    ...
                    { name: "美剧汇", link: 'http://www.meijuhui520.com/search.php?q=' + unititle, selector: 'article.excerpt li.focus' },
                    ...
                    { name: '迅播影院', link: 'http://www.22tu.cc/vodsearch/-------------/?wd=' + unititle + '&submit=%E6%90%9C+%E7%B4%A2', selector: 'ul.mlist div.info' },
                    ...
                    { name: '影视123', link: 'http://www.yingshi123.cn/search.asp?searchword=' + gunititle, selector: '#contents a.title' },
            ...
            site_map.push({
                name: "BT国内网站",
                label: [
                    { name: 'Btdad', link: 'http://www.btdad.pw/search-' + unititle +'-0-0-1.html', selector: 'div.title + div.sbar' },
                    ...
                    { name: 'BT影天堂', link: 'http://www.btbtt08.com/search-index.htm?keyword=' + unititle, selector: '#threadlist td.subject' },
                    ...
                    { name: 'MAG磁力', link: 'http://oabt007.com/index/index?c=&k=' + unititle, selector: 'div.link-list-wrapper ul.link-list' },
                    { name: 'SOBT', link: 'http://sobt5.in/q/' + unititle +'.html', selector: 'div.search-item div.item-title' },
                    { name: 'Tkitty', link: 'https://cn.torrentkitty.me/search/' + unititle, selector: `tbody td.name:not(:contains(没有结果))` },
                    { name: '阿里BT', link: 'https://alibt.pw/zh-cn/s/1/' + unititle, selector: '.resource-list li' },
                    { name: '磁力狗', link: 'http://ciligou.top/search?word=' + unititle, selector: '#Search_list_wrapper div.Search_title_wrapper' },
                    { name: '磁力管家', link: 'http://www.ciliguanjia.icu/sh-' + unititle +'-0-0-1.html', selector: '.search_list .detail' },
                    { name: '磁力链', link: 'https://www.ciliqi.com/main-search.html?kw=' + unititle, selector: '.panel-body .item-title' },
                    { name: '磁力天堂', link: 'http://berrh.com/list?key=' + unititle, selector: 'div.list-con dt' },
                    { name: '磁力·天堂', link: 'http://www.cilitiantang.vip/cilisousuo/' + unititle + '.html', selector: '.btsowlist .row' },
                    { name: '磁力星', link: 'https://www.cilixing.cc/index/searchs.html?keyword=' + unititle, selector: '#biuuu_city_list div.layui-collapse.fly-comar' },
                    { name: '老牛BT', link: 'https://www.laoniubt.top/s.html?kw=' + unititle, selector: 'table.table td.x-item' },
                    { name: '人人磁力', link: 'https://renrenciliba.org/a8/' + unititle +'/1-0-0.html', selector: 'div.list-area dl.item' },
                    { name: '小浣熊下载', link: `https://www.xiaohx.org/search?key=${unititle}`, selector: `div.result_p a[title*='${unititle}']` },
                    { name: '章鱼搜索', link: 'https://bt.octopgo.com/s/' + unititle +'.html', selector: '#list-panel h2.name' },
                    { name: '种子吧', link: 'http://zhongziba.me/search?wd=' + unititle, selector: 'div.media-body h4.media-heading' },
                ]
            });
            if (has_imdb) {
                site_map.push({
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '凌风云搜书', link: 'https://www.lingfengyun.com/search?wd=' + title + '&so_file=1&so_source=1&so_ext=4&so_array=&so_accur=100', csrf: {name: "so_token", update:"link"}, rewrite_href: true, selector: '.search_data_list div.tab' },
                    { name: '如风搜图书', link: 'http://www.rufengso.net/s/comb/n-' + title + '&f-f2', selector: `h3 > a[title*='${title}']` },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: '凌风云搜音', link: 'https://www.lingfengyun.com/search?wd=' + title + singer + '&so_file=1&so_source=1&so_ext=&so_array=file_desc&so_accur=100', csrf: {name: "so_token", update:"link"}, rewrite_href: true, selector: '.search_data_list div.tab' },
                    { name: '如风搜音乐', link: 'http://www.rufengso.net/s/comb/n-' + title + singer + '&f-f13', selector: `h3 > a[title*='${singer.trim()}']` },
            ...
            site_map.push({
                ...
                label: [
                    ...
                    { name: 'Rutrack♬', link: 'http://rutracker.org/forum/search_cse.php?q=' + title, ajax: `https://www.google.com/search?q=allintitle:+${title}+site:rutracker.org`,selector: 'div.r h3' },
                ]
            });
        }
